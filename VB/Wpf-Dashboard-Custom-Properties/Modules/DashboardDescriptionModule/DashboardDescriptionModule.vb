...
Namespace Wpf_Dashboard_Custom_Properties
	Public Class DashboardDescriptionModule
		...
		Protected Overrides Sub OnAttached()
			MyBase.OnAttached()
			Dim resources As ResourceDictionary = DirectCast(Application.LoadComponent(New Uri("/Wpf-Dashboard-Custom-Properties;component/Modules/DashboardDescriptionModule/TitleResources.xaml", UriKind.Relative)), ResourceDictionary)
	...
	Public Class ShowDashboardDescriptionCommandConverter
		...
		Private Sub ShowDescriptionCommand(ByVal value As Object)
			Dim dashboard As Dashboard = DirectCast(value, Dashboard)
