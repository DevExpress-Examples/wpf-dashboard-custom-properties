...
Namespace Wpf_Dashboard_Custom_Properties
	Public Class LineStyleConverter
		...
		Public Function Convert(ByVal values() As Object, ByVal targetType As Type, ByVal parameter As Object, ByVal culture As CultureInfo) As Object Implements IMultiValueConverter.Convert
			Dim dashboardItemName As String = DirectCast(values(0), String)
			Dim dashboardControlProvider As IDashboardControlProvider = DirectCast(values(1), IDashboardControlProvider)
			Dim valueDataMember As String = DirectCast(values(2), String)
	...
	Public Module LineStyleExtensions
		...
		Private Sub UpdateChart(ByVal chartItem As ChartDashboardItem, ByVal context As ChartContext)
			...
			For Each series As SimpleSeries In lineSeries
				...
				Dim dashStyle As DevExpress.XtraCharts.DashStyle = Nothing
