...
Namespace Wpf_Dashboard_Custom_Properties
    ...
    Public Class ConstantLinesConverter
        ...
        Public Function Convert(ByVal values As Object(), ByVal targetType As Type, ByVal parameter As Object, ByVal culture As CultureInfo) As Object Implements IMultiValueConverter.Convert
            ...
            Dim pane = chartItem.Panes.FirstOrDefault(Function(x) x.Name Is moduleData.PaneName)
            Dim constantLines As ConstantLineCollection = New ConstantLineCollection()
            If pane IsNot Nothing Then
                ...
                If dashboardSeries IsNot Nothing Then
                    Dim line As ConstantLine = New ConstantLine()
        ...
        Public Sub CustomExport(ByVal dashboardControl As DashboardControl, ByVal e As CustomExportEventArgs)
            ...
            For Each control In controls
                ...
                If xrChart IsNot Nothing Then
                    ...
                    ConstantLineExtensions.UpdateChart(chart, chartContext)
                End If
            Next
        End Sub
            ...
            If pane IsNot Nothing Then
                ...
                If dashboardSeries IsNot Nothing Then
                    ...
                    If chartAxis IsNot Nothing Then
                        Dim line As DevExpress.XtraCharts.ConstantLine = New DevExpress.XtraCharts.ConstantLine() With {.AxisValue = moduleData.Value}
